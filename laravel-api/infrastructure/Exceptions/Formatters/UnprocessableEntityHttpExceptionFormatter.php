...
use Optimus\Heimdal\Formatters\UnprocessableEntityHttpExceptionFormatter as BD;

class UnprocessableEntityHttpExceptionFormatter extends BD
{
    public function format1(JsonResponse $response, Throwable $e, array $reporterResponses)
    {
